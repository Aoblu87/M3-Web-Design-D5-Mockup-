...
function initializeCarousel() {
  ...
  carousels.forEach((carousel) => {
    // Identifica tutti i "box" specifici per questo carosello
    const boxes = carousel.querySelectorAll('.box');

    // Applica la funzione horizontalLoop specificamente ai box di questo carosello
...
window.addEventListener('cardsRendered', function () {
  initializeCarousel();
});
